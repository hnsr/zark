...
{
      10,     0,    -1,    -1,    10,    11,    -1,     8,    -1,    -1,
       3,    12,    13,     8,    -1,    -1,    13,    14,    -1,     4,
      -1,     5,    -1,     6,    -1,     7,    -1
};
...
{
       0,   162,   162,   162,   164,   166,   165,   233,   233,   259,
     260,   261,   262
};
#endif
...
{
  "$end", "error", "$undefined", "CMDNAME", "STR_ARG", "QSTR_ARG",
  "INT_ARG", "FLOAT_ARG", "CMDEND", "$accept", "cmdstring", "cmdline",
  "$@1", "cmdargs", "cmdarg", 0
};
#endif
