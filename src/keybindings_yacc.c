...
{
       0,     0,     3,     4,     7,     9,    16,    19,    20,    22,
      24,    25,    29,    31,    35,    37,    39,    41,    43
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      19,     0,    -1,    -1,    19,    20,    -1,    10,    -1,    21,
       3,    22,    12,     9,    10,    -1,     1,    10,    -1,    -1,
      13,    -1,    14,    -1,    -1,    15,    23,    16,    -1,    24,
      -1,    23,    17,    24,    -1,     4,    -1,     5,    -1,     6,
      -1,     7,    -1,     8,    -1
};
...
{
       0,   142,   142,   142,   144,   144,   170,   173,   174,   175,
     178,   178,   180,   180,   182,   183,   184,   185,   186
};
#endif
...
{
  "$end", "error", "$undefined", "KEYNAME", "MODSHIFT", "MODSUPER",
  "MODCTRL", "MODLALT", "MODRALT", "CMDLINE", "END", "INVALID", "':'",
  "'+'", "'-'", "'('", "')'", "','", "$accept", "keybindings",
  "keybinding", "keystate", "modifier_keys", "modkeylist", "modkey", 0
};
#endif
...
{
     -12,     0,   -12,    -8,   -12,   -12,   -12,   -12,    12,   -12,
     -11,     1,     4,   -12,   -12,   -12,   -12,   -12,    -5,   -12,
       8,   -12,     1,     9,   -12,   -12
};
...
{
       2,     3,     9,    -7,    11,    13,    14,    15,    16,    17,
       4,    21,    22,     5,     6,    10,    20,    23,    24,    25
};

static const yytype_uint8 yycheck[] =
{
       0,     1,    10,     3,    15,     4,     5,     6,     7,     8,
      10,    16,    17,    13,    14,     3,    12,     9,    22,    10
};
...
{
       0,    19,     0,     1,    10,    13,    14,    20,    21,    10,
       3,    15,    22,     4,     5,     6,     7,     8,    23,    24,
      12,    16,    17,     9,    24,    10
};
...
/* Line 1455 of yacc.c  */
#line 182 "keybindings_yacc.y"
    { modmask |= Z_KEY_MOD_SHIFT; }
    break;

  case 15:

/* Line 1455 of yacc.c  */
#line 183 "keybindings_yacc.y"
    { modmask |= Z_KEY_MOD_SUPER; }
    break;

  case 16:

/* Line 1455 of yacc.c  */
#line 184 "keybindings_yacc.y"
    { modmask |= Z_KEY_MOD_CTRL;  }
    break;

  case 17:

/* Line 1455 of yacc.c  */
#line 185 "keybindings_yacc.y"
    { modmask |= Z_KEY_MOD_LALT;  }
    break;

  case 18:

/* Line 1455 of yacc.c  */
#line 186 "keybindings_yacc.y"
    { modmask |= Z_KEY_MOD_RALT;  }
    break;



/* Line 1455 of yacc.c  */
#line 1559 "keybindings_yacc.c"
      default: break;
    }
